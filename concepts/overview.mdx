...
<Callout icon="notes" color="#D3D3D3">Build the mental model everything else depends on. This can be reference-y. Try not to be overwhelming so as to encourage consumption. Basically take the current Concepts section and cut it in half. </Callout>
